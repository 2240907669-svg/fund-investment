...
def build_docx():
    ...
    add_table(doc, ["问题", "结论"], [
        ...
        ["2）下一开放日买不买", "不买。申购金额上限为0元，因此本次晚报没有给出可提交的预埋申购草案；但项目规则允许晚报在条件充分时授权下一开放日的条件式预埋申购草案。只有在现金真实余额、申购状态、费率确认，且国家统计局数据后宽基成交延续、电子特气/半导体材料链和通信资金连续净流入、世界人工智能大会出现具体政策或订单时，才重新评估分批买入。"],
    ...
    add_table(doc, ["方向", "行业", "净额", "价格验证", "解释"], [
        ...
        ["流入", "通信设备+通信", "约+174.4亿元", "+1.59%/+0.82%", "国泰中证全指通信设备ETF联接C相关方向改善，支持继续观察而非追买"],
